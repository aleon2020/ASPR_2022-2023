...
#ifndef SEEK_AND_CAPTURE_FOROCOCHES__DEBUGNODE_HPP_
#define SEEK_AND_CAPTURE_FOROCOCHES__DEBUGNODE_HPP_
...
public:
  ...
  static const int PERSON_DETECTED = 2;
  static const int PERSON_FOUND = 3;
  static const int OK = 9;
  static const int READY = 17;
  static const int ROTATING = 29;
  static const int MOVING_REALLY_SLOW = 30;
  static const int MOVING_SLOW = 31;
  static const int MOVING_MODERATE = 32;
  static const int MOVING_FAST = 33;
  static const int MOVING_TOO_FAST = 34;
  static const int MOVING_NO_CONTROL = 35;
  static const int LOW_BATTERY = 40;
...
#endif  // SEEK_AND_CAPTURE_FOROCOCHES__DEBUGNODE_HPP_
