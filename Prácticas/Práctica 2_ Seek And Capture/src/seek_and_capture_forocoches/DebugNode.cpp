...
void DebugNode::control_cycle()
{
  ...
  switch (last_debug_msg_->data) {
    ...
    case PERSON_DETECTED:
      ...
      RCLCPP_DEBUG(get_logger(), "PERSON_DETECTED");
      break;
    case PERSON_FOUND:
      set_led1_value(LED_OFF);
    ...
    case READY:
      ...
      break;
    case ROTATING:
      set_led1_value(LED_ORANGE, FLASHING);
      set_led2_value(LED_OFF);
      RCLCPP_DEBUG(get_logger(), "ROTATING");
      break;
    case MOVING_REALLY_SLOW:
      set_led1_value(LED_ORANGE, FLASHING);
      set_led2_value(LED_GREEN);
      RCLCPP_DEBUG(get_logger(), "MOVING_REALLY_SLOW");
      break;
    case MOVING_SLOW:
      set_led1_value(LED_ORANGE, FLASHING);
      set_led2_value(LED_GREEN, FLASHING);
      RCLCPP_DEBUG(get_logger(), "MOVING_SLOW");
      break;
    case MOVING_MODERATE:
      set_led1_value(LED_ORANGE, FLASHING);
      set_led2_value(LED_ORANGE);
      RCLCPP_DEBUG(get_logger(), "MOVING_MODERATE");
      break;
    case MOVING_FAST:
      set_led1_value(LED_ORANGE, FLASHING);
      set_led2_value(LED_ORANGE, FLASHING);
      RCLCPP_DEBUG(get_logger(), "MOVING_FAST");
      break;
    case MOVING_TOO_FAST:
      set_led1_value(LED_ORANGE, FLASHING);
      set_led2_value(LED_RED);
      RCLCPP_DEBUG(get_logger(), "MOVING_TOO_FAST");
      break;
    case MOVING_NO_CONTROL:
      set_led1_value(LED_ORANGE, FLASHING);
      set_led2_value(LED_RED, FLASHING);
      set_sound(SOUND_ERROR);
      RCLCPP_DEBUG(get_logger(), "MOVING_NO_CONTROL");
      break;
    case LOW_BATTERY:
      set_led1_value(LED_RED);
      set_led2_value(LED_ORANGE, FLASHING);
      RCLCPP_DEBUG(get_logger(), "LOW_BATTERY");
      break;
    case NOT_ON_GROUND:
      set_led1_value(LED_RED);
      set_led2_value(LED_RED);
